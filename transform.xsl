...
<xsl:stylesheet
    ...
    <xsl:template match="tei:respStmt">
        <table>
            <tr>
                <td><xsl:value-of select="tei:name[@xml:id='matt_chiar']"/></td>
                <td><xsl:value-of select="tei:name[@xml:id='matt_nico']"/></td>
            </tr>
        </table>
    </xsl:template>
    ...
    <xsl:template match="tei:monogr">
        <table>
            <tr>
                ...
                <td><xsl:value-of select="tei:name[@xml:id='Franchetti']"/></td>
                <td><xsl:value-of select="tei:name[@xml:id='Sonnino']"/></td>
            </tr>
